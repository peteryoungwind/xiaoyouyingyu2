    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(c -> c.disable())
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/shadowing-lessons").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/shadowing-lessons/*").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/shadowing-lessons/*/sentences/*/review").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/shadowing-lessons/*/sentences/*/review-base64").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/shadowing-lessons/speech-to-text").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/shadowing-lessons/speech-to-text-base64").authenticated()
